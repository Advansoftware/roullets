const prizes = [
  { label: "1000", icon: "fa-crown", color: "#f1c40f", textColor: "#1a1a2a" },
  { label: "SURPRESA", icon: "fa-mask", color: "#9b59b6", textColor: "#fff" },
  { label: "PONTOS", icon: "fa-star", color: "#27ae60", textColor: "#fff" },
  { label: "50", icon: "fa-gem", color: "#e91e63", textColor: "#fff" },
  { label: "BRINDE", icon: "fa-gift", color: "#3498db", textColor: "#fff" },
  { label: "100", icon: "fa-trophy", color: "#9b59b6", textColor: "#fff" },
  { label: "BÔNUS", icon: "fa-dice", color: "#27ae60", textColor: "#fff" },
  { label: "500MM", icon: "fa-award", color: "#e91e63", textColor: "#fff" }
];
