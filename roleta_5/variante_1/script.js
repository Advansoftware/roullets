const prizes = [
  { label: "1000", icon: "fa-coins", color: "#d4af37", textColor: "#0a0a0a" },      // HIGHLIGHT (Gold)
  { label: "SURPRESA", icon: "fa-gift", color: "#1a1a1a", textColor: "#d4af37" },   // COLOR A (Black)
  { label: "PONTOS", icon: "fa-star", color: "#2a2a2a", textColor: "#d4af37" },     // COLOR B (Dark Gray)
  { label: "50", icon: "fa-gem", color: "#1a1a1a", textColor: "#d4af37" },          // COLOR A
  { label: "BRINDE", icon: "fa-gift", color: "#2a2a2a", textColor: "#d4af37" },     // COLOR B
  { label: "100", icon: "fa-trophy", color: "#1a1a1a", textColor: "#d4af37" },      // COLOR A
  { label: "BÔNUS", icon: "fa-dice", color: "#2a2a2a", textColor: "#d4af37" },      // COLOR B
  { label: "500MM", icon: "fa-award", color: "#1a1a1a", textColor: "#d4af37" }      // COLOR A
];
...
function createSectorElement(prize, index, sectorAngle) {
  ...
  content.style.color = prize.textColor || "#d4af37";
...
function createConfetti() {
  ...
  const colors = ['#d4af37', '#f7e7a0', '#8b7355', '#fff', '#c9a227'];
