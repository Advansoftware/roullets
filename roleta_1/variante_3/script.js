const prizes = [
  { label: "1000", icon: "fa-coins", color: "#cd7f32", textColor: "#fff" },         // HIGHLIGHT (Bronze) - Only special
  { label: "SURPRESA", icon: "fa-gift", color: "#5c3317", textColor: "#fff" },      // COLOR A (Dark Brown)
  { label: "PONTOS", icon: "fa-star", color: "#daa520", textColor: "#fff" },        // COLOR B (Goldenrod)
  { label: "50", icon: "fa-gem", color: "#5c3317", textColor: "#fff" },             // COLOR A (Dark Brown)
  { label: "BRINDE", icon: "fa-gift", color: "#daa520", textColor: "#fff" },        // COLOR B (Goldenrod)
  { label: "100", icon: "fa-trophy", color: "#5c3317", textColor: "#fff" },         // COLOR A (Dark Brown)
  { label: "BÔNUS", icon: "fa-dice", color: "#daa520", textColor: "#fff" },         // COLOR B (Goldenrod)
  { label: "500MM", icon: "fa-award", color: "#5c3317", textColor: "#fff" }         // COLOR A (Dark Brown)
];
