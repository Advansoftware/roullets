const prizes = [
  { label: "1000", icon: "fa-champagne-glasses", color: "#ffd700", textColor: "#0a0a0a" },  // HIGHLIGHT (Gold)
  { label: "SURPRESA", icon: "fa-gift", color: "#4a0080", textColor: "#ffd700" },           // COLOR A (Purple)
  { label: "PONTOS", icon: "fa-star", color: "#c0c0c0", textColor: "#0a0a0a" },             // COLOR B (Silver)
  { label: "50", icon: "fa-gem", color: "#4a0080", textColor: "#ffd700" },                  // COLOR A
  { label: "BRINDE", icon: "fa-glass-cheers", color: "#c0c0c0", textColor: "#0a0a0a" },     // COLOR B
  { label: "100", icon: "fa-trophy", color: "#4a0080", textColor: "#ffd700" },              // COLOR A
  { label: "BÔNUS", icon: "fa-firework", color: "#c0c0c0", textColor: "#0a0a0a" },          // COLOR B
  { label: "500MM", icon: "fa-award", color: "#4a0080", textColor: "#ffd700" }              // COLOR A
];
...
function createConfetti() {
  ...
  const colors = ['#ffd700', '#c0c0c0', '#4a0080', '#fff', '#f7e7ce'];
