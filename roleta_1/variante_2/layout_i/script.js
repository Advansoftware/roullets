const prizes = [
  { label: "1000", icon: "fa-coins", color: "#fcd34d", textColor: "#fff" },         // HIGHLIGHT (Gold) - Only special
  { label: "SURPRESA", icon: "fa-gift", color: "#7f1d1d", textColor: "#fff" },      // COLOR A (Dark Red)
  { label: "PONTOS", icon: "fa-star", color: "#fb923c", textColor: "#fff" },        // COLOR B (Light Orange)
  { label: "50", icon: "fa-gem", color: "#7f1d1d", textColor: "#fff" },             // COLOR A (Dark Red)
  { label: "BRINDE", icon: "fa-gift", color: "#fb923c", textColor: "#fff" },        // COLOR B (Light Orange)
  { label: "100", icon: "fa-trophy", color: "#7f1d1d", textColor: "#fff" },         // COLOR A (Dark Red)
  { label: "BÔNUS", icon: "fa-dice", color: "#fb923c", textColor: "#fff" },         // COLOR B (Light Orange)
  { label: "500MM", icon: "fa-award", color: "#7f1d1d", textColor: "#fff" }         // COLOR A (Dark Red)
];
