const prizes = [
  { label: "1000", icon: "fa-coins", color: "#eab308", textColor: "#fff" },
  { label: "SURPRESA", icon: "fa-gift", color: "#9a3412", textColor: "#fff" },
  { label: "PONTOS", icon: "fa-star", color: "#0f766e", textColor: "#fff" },
  { label: "50", icon: "fa-gem", color: "#9a3412", textColor: "#fff" },
  { label: "BRINDE", icon: "fa-gift", color: "#0f766e", textColor: "#fff" },
  { label: "100", icon: "fa-trophy", color: "#9a3412", textColor: "#fff" },
  { label: "BÔNUS", icon: "fa-dice", color: "#0f766e", textColor: "#fff" },
  { label: "500MM", icon: "fa-award", color: "#9a3412", textColor: "#fff" }
];
