const prizes = [
  { label: "1000", icon: "fa-coins", color: "#fef08a", textColor: "#1e3a5f" },      // HIGHLIGHT (Yellow) - Main Prize
  { label: "SURPRESA", icon: "fa-gift", color: "#fbcfe8", textColor: "#1e3a5f" },   // COLOR A (Pink)
  { label: "PONTOS", icon: "fa-star", color: "#99f6e4", textColor: "#1e3a5f" },     // COLOR B (Mint)
  { label: "50", icon: "fa-gem", color: "#fbcfe8", textColor: "#1e3a5f" },          // COLOR A (Pink)
  { label: "BRINDE", icon: "fa-gift", color: "#99f6e4", textColor: "#1e3a5f" },     // COLOR B (Mint)
  { label: "100", icon: "fa-trophy", color: "#fbcfe8", textColor: "#1e3a5f" },      // COLOR A (Pink)
  { label: "BÔNUS", icon: "fa-dice", color: "#99f6e4", textColor: "#1e3a5f" },      // COLOR B (Mint)
  { label: "500MM", icon: "fa-award", color: "#fbcfe8", textColor: "#1e3a5f" }      // COLOR A (Pink) - Fixed!
];
