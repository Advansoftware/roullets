const prizes = [
  { label: "1000", icon: "fa-gift", color: "#f5b82e", textColor: "#1a0a0a" },        // HIGHLIGHT (Gold)
  { label: "SURPRESA", icon: "fa-tree", color: "#c41e3a", textColor: "#fff" },       // COLOR A (Red)
  { label: "PONTOS", icon: "fa-star", color: "#165b33", textColor: "#fff" },         // COLOR B (Green)
  { label: "50", icon: "fa-snowflake", color: "#c41e3a", textColor: "#fff" },        // COLOR A
  { label: "BRINDE", icon: "fa-candy-cane", color: "#165b33", textColor: "#fff" },   // COLOR B
  { label: "100", icon: "fa-bell", color: "#c41e3a", textColor: "#fff" },            // COLOR A
  { label: "BÔNUS", icon: "fa-holly-berry", color: "#165b33", textColor: "#fff" },   // COLOR B
  { label: "500MM", icon: "fa-sleigh", color: "#c41e3a", textColor: "#fff" }         // COLOR A
];
...
function createConfetti() {
  ...
  const colors = ['#c41e3a', '#165b33', '#f5b82e', '#fff', '#ff6b6b'];
