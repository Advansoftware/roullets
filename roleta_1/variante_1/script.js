const prizes = [
  { label: "1000", icon: "fa-coins", color: "#FDC500", textColor: "#fff" },         // HIGHLIGHT (Yellow) - Only special
  { label: "SURPRESA", icon: "fa-gift", color: "#3A0CA3", textColor: "#fff" },      // COLOR A (Dark Blue)
  { label: "PONTOS", icon: "fa-star", color: "#4CC9F0", textColor: "#fff" },        // COLOR B (Light Blue)
  { label: "50", icon: "fa-gem", color: "#3A0CA3", textColor: "#fff" },             // COLOR A (Dark Blue)
  { label: "BRINDE", icon: "fa-gift", color: "#4CC9F0", textColor: "#fff" },        // COLOR B (Light Blue)
  { label: "100", icon: "fa-trophy", color: "#3A0CA3", textColor: "#fff" },         // COLOR A (Dark Blue)
  { label: "BÔNUS", icon: "fa-dice", color: "#4CC9F0", textColor: "#fff" },         // COLOR B (Light Blue)
  { label: "500MM", icon: "fa-award", color: "#3A0CA3", textColor: "#fff" }         // COLOR A (Dark Blue) - continues pattern
];
...
function initWheel() {
  ...
  prizes.forEach((prize, index) => {
    // NÃO aplicar offset aqui - usamos "from Xdeg" no conic-gradient
  ...
  // Usar "from Xdeg" para rotacionar o gradiente inteiramente
