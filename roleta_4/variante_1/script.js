const prizes = [
  { label: "1000", icon: "fa-coins", color: "#ffcc00", textColor: "#000" },         // HIGHLIGHT (Yellow)
  { label: "SURPRESA", icon: "fa-gift", color: "#ff0055", textColor: "#fff" },      // COLOR A (Red)
  { label: "PONTOS", icon: "fa-star", color: "#00ff88", textColor: "#000" },        // COLOR B (Green)
  { label: "50", icon: "fa-gem", color: "#ff0055", textColor: "#fff" },             // COLOR A
  { label: "BRINDE", icon: "fa-gift", color: "#00ff88", textColor: "#000" },        // COLOR B
  { label: "100", icon: "fa-trophy", color: "#ff0055", textColor: "#fff" },         // COLOR A
  { label: "BÔNUS", icon: "fa-dice", color: "#00ff88", textColor: "#000" },         // COLOR B
  { label: "500MM", icon: "fa-award", color: "#ff0055", textColor: "#fff" }         // COLOR A
];
