const prizes = [
  { label: "1000", icon: "fa-coins", color: "#f1c40f", textColor: "#5d4037" },      // HIGHLIGHT (Yellow)
  { label: "SURPRESA", icon: "fa-gift", color: "#c0392b", textColor: "#f5e6d3" },   // COLOR A (Red)
  { label: "PONTOS", icon: "fa-star", color: "#f5e6d3", textColor: "#5d4037" },     // COLOR B (Cream)
  { label: "50", icon: "fa-gem", color: "#c0392b", textColor: "#f5e6d3" },          // COLOR A
  { label: "BRINDE", icon: "fa-gift", color: "#f5e6d3", textColor: "#5d4037" },     // COLOR B
  { label: "100", icon: "fa-trophy", color: "#c0392b", textColor: "#f5e6d3" },      // COLOR A
  { label: "BÔNUS", icon: "fa-dice", color: "#f5e6d3", textColor: "#5d4037" },      // COLOR B
  { label: "500MM", icon: "fa-award", color: "#c0392b", textColor: "#f5e6d3" }      // COLOR A
];
...
function createSectorElement(prize, index, sectorAngle) {
  ...
  content.style.color = prize.textColor || "#5d4037";
...
function createConfetti() {
  ...
  const colors = ['#c0392b', '#f1c40f', '#f5e6d3', '#5d4037', '#d4a574'];
