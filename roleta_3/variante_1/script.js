const prizes = [
  { label: "1000", icon: "fa-coins", color: "#6366f1", textColor: "#fff" },         // HIGHLIGHT (Indigo)
  { label: "SURPRESA", icon: "fa-gift", color: "#f1f5f9", textColor: "#334155" },   // COLOR A (Light Gray)
  { label: "PONTOS", icon: "fa-star", color: "#e2e8f0", textColor: "#334155" },     // COLOR B (Slate)
  { label: "50", icon: "fa-gem", color: "#f1f5f9", textColor: "#334155" },          // COLOR A
  { label: "BRINDE", icon: "fa-gift", color: "#e2e8f0", textColor: "#334155" },     // COLOR B
  { label: "100", icon: "fa-trophy", color: "#f1f5f9", textColor: "#334155" },      // COLOR A
  { label: "BÔNUS", icon: "fa-dice", color: "#e2e8f0", textColor: "#334155" },      // COLOR B
  { label: "500MM", icon: "fa-award", color: "#f1f5f9", textColor: "#334155" }      // COLOR A
];
